...
CREATE POLICY "Experience can be modified" ON experience FOR ALL USING (true);
...
-- ============================================
-- Note: Create a storage bucket named 'images' in the Supabase Dashboard
-- with public access for image uploads
